    ...
    <div className="product-card">
      ...
      >
        <div className="product-image-container">
          <img
            src={hoveredIndex ? product.hoverimage : product.image}
            alt={product.name}
            ...
            <>
              <div className="hoverd-icon">
                ...
                <div className="compare" onClick={() => handleCompare(product)}>
                  {compare.some((item) => item.id === product.id) ? (
                    <AiOutlineDelete className="delete" />
                  ) : (
                    <IoGitCompareOutline />
                  )}
              ...
              <div className="addToCart">
                <div
                  className={`button Raleway ${product.stokout ? "disabled" : ""}`}
        ...
        <div className="product-details">
          <h3 className="product-title Raleway">{product.name}</h3>
